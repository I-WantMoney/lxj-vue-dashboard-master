  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/icons" :name="$t('sidebar.icons')" icon="tim-icons icon-bag-16"/>
        ...
        <sidebar-link to="/chat" :name="$t('sidebar.chat')" icon="tim-icons icon-chat-33"/>
        <sidebar-link to="/ai" :name="$t('sidebar.ai')" icon="tim-icons icon-satisfied"/>
        <sidebar-link to="/geo" :name="$t('sidebar.geo')" icon="tim-icons icon-square-pin"/>
